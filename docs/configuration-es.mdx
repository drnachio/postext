...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>boolean</code></td>
      <td><code>true</code></td>
      <td>Cuando es <code>true</code>, un encabezado nunca se coloca como último elemento de una columna o página. Si el siguiente bloque no tuviera al menos una línea de hueco tras el encabezado, el encabezado se empuja hacia delante para quedar unido a su texto.</td>
    </tr>
  </tbody>
</table>
