...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>'column' | 'page'</code></td>
      <td><code>'column'</code></td>
      <td>Extensión horizontal: la columna o el ancho completo del área de contenido. Se puede sobrescribir por instancia con el atributo <code>span</code>. Se registra en el VDT; en disposiciones multicolumna <code>'page'</code> se compone por ahora en línea al ancho de columna (fase de paginación pendiente).</td>
    </tr>
    <tr>
      <td><code>placement</code></td>
      <td><code>'here' | 'top' | 'bottom'</code></td>
      <td><code>'here'</code></td>
      <td>En línea en el flujo, o flotando a una banda superior / inferior de la página como un recurso. Se puede sobrescribir por instancia con el atributo <code>placement</code>. Las colocaciones flotantes se registran pero por ahora se colocan en línea (fase de paginación pendiente).</td>
    </tr>
    <tr>
      <td><code>width</code></td>
...
- `span: 'page'` en disposiciones multicolumna y `placement: 'top' | 'bottom'` se registran en el VDT (`VDTBlock.callout`) pero todavía se colocan en línea al ancho de columna — las cajas a ancho completo y flotantes llegan con la fase de paginación.
