...
The running text is never broken at the reference point. Where the resource lands — top or bottom of the page, within a single column or across the full width — is governed by its **placement** (see [Placement](#resource-placement) below), not by where you mention it.
