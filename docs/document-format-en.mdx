...
<Illustration name="BlockTypesGallery" data='{"title": "Block constructs at a glance", "desc": "The six block types Postext recognises: heading, paragraph, blockquote, unordered list, ordered list, and task list, each with its markdown syntax.", "caption": "Every block type and its markdown entry point.", "blocks": [{"name": "Heading", "syntax": "# Title", "color": "blue"}, {"name": "Paragraph", "syntax": "Plain text lines", "color": "orange"}, {"name": "Blockquote", "syntax": "> quoted text", "color": "green"}, {"name": "Unordered list", "syntax": "- item", "color": "purple"}, {"name": "Ordered list", "syntax": "1. item", "color": "pink"}, {"name": "Task list", "syntax": "- [x] done", "color": "teal"}]}' />
