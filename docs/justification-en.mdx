...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>1.7</code></td>
      <td>Upper bound for word spacing, as a multiplier of the normal space width. At the default value, spaces can stretch up to 170% of their natural width.</td>
    </tr>
    <tr>
...
At the defaults (1.7 / 0.5), if the normal space width is 4 px:
- Each space can stretch by 2.8 px (from 4 px to 6.8 px)
...
The defaults of 1.7 and 0.5 favor the algorithm's flexibility — giving Knuth-Plass enough room to avoid overflow, hyphenation, and runts across narrow columns, while still being well within ranges typographic literature considers acceptable.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Increase <code>maxWordSpacing</code> slightly (e.g., from 1.7 to 2.0). This gives the algorithm more room.</td>
    </tr>
    <tr>
...
const vdt = buildDocument(content, {
  bodyText: {
    ...
    maxWordSpacing: 1.7,   // spaces stretch up to 170%
