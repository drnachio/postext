...
<svg viewBox="0 0 760 220" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: '760px', fontFamily: 'monospace' }}>
  <defs>
    <filter id="justShadow" x="-4%" y="-4%" width="108%" height="108%">
  ...
  {/* Greedy column */}
  <rect x="20" y="30" width="340" height="170" fill="var(--svg-pink-fill)" stroke="#E91E63" strokeWidth="2" rx="6" filter="url(#justShadow)" />
  <text x="190" y="55" textAnchor="middle" fontSize="12" fontWeight="bold" fill="var(--svg-pink-text)">Greedy first-fit</text>
  <line x1="40" y1="65" x2="340" y2="65" stroke="#E91E63" strokeWidth="1" opacity="0.3" />

  <text x="40" y="85" fontSize="10" fill="var(--svg-pink-text)">Decides line by line, no look-ahead</text>
  <text x="40" y="105" fontSize="10" fill="var(--svg-mid-text)">&#x2717;  One bad break poisons the next line</text>
  <text x="40" y="125" fontSize="10" fill="var(--svg-mid-text)">&#x2717;  Uneven spacing across the paragraph</text>
  <text x="40" y="145" fontSize="10" fill="var(--svg-mid-text)">&#x2717;  Rivers of white space</text>
  <text x="40" y="165" fontSize="10" fill="var(--svg-mid-text)">&#x2717;  No cost model for adjacent lines</text>
  <text x="40" y="185" fontSize="10" fill="var(--svg-mid-text)">= What CSS does</text>
  ...
  {/* KP column */}
  <rect x="420" y="30" width="320" height="170" fill="var(--svg-green-fill)" stroke="#4CAF50" strokeWidth="2" rx="6" filter="url(#justShadow)" />
  <text x="580" y="55" textAnchor="middle" fontSize="12" fontWeight="bold" fill="var(--svg-green-text)">Knuth-Plass optimal</text>
  <line x1="440" y1="65" x2="720" y2="65" stroke="#4CAF50" strokeWidth="1" opacity="0.3" />

  <text x="440" y="85" fontSize="10" fill="var(--svg-green-text)">Evaluates every possible break set</text>
  <text x="440" y="105" fontSize="10" fill="var(--svg-green-text)">&#x2713;  Globally minimal demerits</text>
  <text x="440" y="125" fontSize="10" fill="var(--svg-green-text)">&#x2713;  Even spacing throughout</text>
  <text x="440" y="145" fontSize="10" fill="var(--svg-green-text)">&#x2713;  Consecutive-hyphen penalty</text>
  <text x="440" y="165" fontSize="10" fill="var(--svg-green-text)">&#x2713;  Fitness-class smoothness</text>
  <text x="440" y="185" fontSize="10" fill="var(--svg-green-text)">= What Postext does</text>
</svg>
