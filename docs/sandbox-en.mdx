...
A form-based editor for `PostextConfig`. Settings are grouped into sections:

| Section | Settings |
|---------|----------|
| **Columns** | Column count, gutter width, column balancing |
| **Typography** | Orphans, widows, hyphenation, rag optimization |
| **References** | Footnote placement and markers, figure/table numbering, margin notes |
| **Resource Placement** | Default strategy, defer placement, aspect ratio preservation |
| **Renderer** | Web or PDF output target |

Changes take effect immediately in the viewport preview.
