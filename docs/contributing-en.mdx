...
<Illustration name="ContributionAreas" data='{"title": "Four areas where you can help", "desc": "Four quadrants with concrete examples in each: code and algorithms, design and typography, documentation and community, format and schema.", "caption": "No need to touch code: four fronts where a contribution makes a real difference.", "areas": [{"name": "Code & algorithms", "items": ["Knuth-Plass, columns", "PDF generation", "Rendering & metrics", "Performance"]}, {"name": "Design & typography", "items": ["Editorial design", "Typographic traditions", "Magazines & newspapers", "Non-Latin scripts"]}, {"name": "Docs & community", "items": ["Improve docs", "Translations", "Cross-browser testing", "Onboarding newcomers"]}, {"name": "Format & schema", "items": ["Enriched markdown", "Config schema", "Editorial semantics", "Public APIs"]}]}' />
...
1. **Introduce yourself in [Discussions](https://github.com/drnachio/postext/discussions)** —
   say what you work on and what brought you here. It is the fastest way for the community to
