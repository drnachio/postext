...
- [Table style](#table-style) and [Caption style](#caption-style) — typography and decoration for table resources and their captions.
...
The `tableStyle` property controls the typography and decoration of table resources. Body and header cells are styled independently. Font family, size, and colours inherit the resolved body text when unset, so a document with no `tableStyle` renders tables with body-text typography.
