...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>boolean</code></td>
      <td><code>true</code></td>
      <td>When <code>true</code>, a heading is never placed as the last element of a column or page. If the following block would not have at least one line of room after the heading, the heading is pushed forward so it stays joined to its text.</td>
    </tr>
  </tbody>
</table>
