...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Force a page break before every heading of this level. <code>parity: 'odd'</code> / <code>'even'</code> further constrains which side of the spread the heading opens on — a blank padding page is inserted when needed (still counted in the page numbering).</td>
    </tr>
  </tbody>
</table>
