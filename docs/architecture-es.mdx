...
- **Primer hueco, no orden de primera referencia.** Los flotados pendientes se ofrecen a cada hueco en orden de primera referencia, pero uno que no cabe en ninguna parte no retiene a los que vienen detrás — cada uno toma el primer hueco en el que cabe, así que una figura posterior puede aterrizar ocasionalmente antes que una anterior. La numeración no se ve afectada: sigue el orden de primera referencia en el texto.
