...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>2</code></td>
      <td>Límite superior del espaciado entre palabras, como multiplicador del ancho normal del espacio. Con el valor por defecto, los espacios pueden estirarse hasta el 200% de su ancho natural.</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Aumenta <code>maxWordSpacing</code> ligeramente (por ej., de 2 a 2.5). Esto le da más espacio al algoritmo.</td>
    </tr>
    <tr>
