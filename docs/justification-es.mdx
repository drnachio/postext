...
<svg viewBox="0 0 760 220" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: '760px', fontFamily: 'monospace' }}>
  <defs>
    <filter id="justShadowEs" x="-4%" y="-4%" width="108%" height="108%">
      <feDropShadow dx="0" dy="2" stdDeviation="3" floodOpacity="0.15" />
    </filter>
  </defs>
  <rect width="760" height="220" fill="transparent" rx="8" />

  {/* Greedy column */}
  <rect x="20" y="30" width="340" height="170" fill="var(--svg-pink-fill)" stroke="#E91E63" strokeWidth="2" rx="6" filter="url(#justShadowEs)" />
  <text x="190" y="55" textAnchor="middle" fontSize="12" fontWeight="bold" fill="var(--svg-pink-text)">Voraz (primer ajuste)</text>
  <line x1="40" y1="65" x2="340" y2="65" stroke="#E91E63" strokeWidth="1" opacity="0.3" />

  <text x="40" y="85" fontSize="10" fill="var(--svg-pink-text)">Decide línea por línea, sin anticipación</text>
  <text x="40" y="105" fontSize="10" fill="var(--svg-mid-text)">&#x2717;  Un mal corte envenena la siguiente línea</text>
  <text x="40" y="125" fontSize="10" fill="var(--svg-mid-text)">&#x2717;  Espaciado irregular en el párrafo</text>
  <text x="40" y="145" fontSize="10" fill="var(--svg-mid-text)">&#x2717;  Ríos de espacio en blanco</text>
  <text x="40" y="165" fontSize="10" fill="var(--svg-mid-text)">&#x2717;  Sin modelo de coste entre líneas</text>
  <text x="40" y="185" fontSize="10" fill="var(--svg-mid-text)">= Lo que hace CSS</text>

  {/* Arrow */}
  <path d="M380,115 L410,115" stroke="var(--svg-stroke)" strokeWidth="2" fill="none" />
  <polygon points="410,110 420,115 410,120" fill="var(--svg-stroke)" />

  {/* KP column */}
  <rect x="420" y="30" width="320" height="170" fill="var(--svg-green-fill)" stroke="#4CAF50" strokeWidth="2" rx="6" filter="url(#justShadowEs)" />
  <text x="580" y="55" textAnchor="middle" fontSize="12" fontWeight="bold" fill="var(--svg-green-text)">Knuth-Plass óptimo</text>
  <line x1="440" y1="65" x2="720" y2="65" stroke="#4CAF50" strokeWidth="1" opacity="0.3" />

  <text x="440" y="85" fontSize="10" fill="var(--svg-green-text)">Evalúa todos los conjuntos de ruptura</text>
  <text x="440" y="105" fontSize="10" fill="var(--svg-green-text)">&#x2713;  Deméritos globalmente mínimos</text>
  <text x="440" y="125" fontSize="10" fill="var(--svg-green-text)">&#x2713;  Espaciado uniforme en todo el texto</text>
  <text x="440" y="145" fontSize="10" fill="var(--svg-green-text)">&#x2713;  Penalización por guiones consecutivos</text>
  <text x="440" y="165" fontSize="10" fill="var(--svg-green-text)">&#x2713;  Suavidad de clase de ajuste</text>
  <text x="440" y="185" fontSize="10" fill="var(--svg-green-text)">= Lo que hace Postext</text>
</svg>
