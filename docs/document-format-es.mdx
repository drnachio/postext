...
El texto nunca se corta en el punto de la referencia. Dónde aterriza el recurso —arriba o abajo de la página, en una sola columna o a todo el ancho— lo decide su **colocación** (ver [Colocación](#colocacion-de-recursos) más abajo), no el lugar donde lo mencionas.
