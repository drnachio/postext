# De lo que contó un cabrero a los que estaban con don Quijote {lead="Estando en esto, llegó otro mozo de los que les traían del aldea el bastimento, y dijo:"}

::resource{id="c12-head"}
...
:::callout{type="nota" title="Grisóstomo"}
...
:::callout{type="nota" title="Marcela"}
...
:::callout{type="nota" title="Cris y estil"}
