...
— No —dijo la sobrina—, no hay para qué perdonar a ninguno, porque todos han sido los dañadores; mejor será arrojarlos por las ventanas al patio, y hacer un rimero dellos y pegarles fuego; y si no, llevarlos al corral, y allí se hará la hoguera, y no ofenderá el humo. (:ref{id="c06-books" case="lower"})
...
:::callout{type="nota" title="Amadís de Gaula"}
...
:::callout{type="nota" title="La Galatea"}
