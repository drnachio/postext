...
export function FeaturesSection() {
  ...
  return (
    <section className="mx-auto w-full max-w-5xl px-6 py-24">
      ...
      <div className="mt-16 grid grid-cols-1 gap-0 md:grid-cols-[1fr_1px_1fr]">
        <div className="space-y-12 md:pr-12">
          {leftColumn.map((feature) => (
            <div key={feature.title}>
              ...
              <p className="mt-2 leading-[1.8] text-slate">
                {feature.description}
              </p>
            </div>
          ))}
        ...
        <div className="column-rule my-0 hidden md:block" />

        <div className="mt-12 space-y-12 md:mt-0 md:pl-12">
