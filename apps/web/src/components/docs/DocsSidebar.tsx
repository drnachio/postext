...
export function DocsSidebar({ docs }: DocsSidebarProps) {
  ...
  return (
    <aside className="sticky top-[var(--docs-nav-h)] hidden h-[calc(100vh-var(--docs-nav-h))] w-56 shrink-0 overflow-y-auto border-r border-rule py-6 pr-4 lg:block 2xl:w-64">
