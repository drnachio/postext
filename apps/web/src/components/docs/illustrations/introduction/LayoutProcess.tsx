...
export function LayoutProcess({ labels }: { labels: LayoutProcessLabels }) {
  return (
    <Figure title={labels.title} desc={labels.desc} caption={labels.caption} viewBox="0 0 760 120" maxWidth={760}>
      ...
      <g>
        <line x1={190} y1={60} x2={270} y2={60} stroke="var(--svg-stroke)" strokeWidth={2} markerEnd="url(#pipeArrow)" />
      ...
      <g>
        <line x1={490} y1={60} x2={570} y2={60} stroke="var(--svg-stroke)" strokeWidth={2} markerEnd="url(#pipeArrow)" />
