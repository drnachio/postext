...
export function DataFlow({ labels }: { labels: DataFlowLabels }) {
  ...
  return (
    <Figure title={labels.title} desc={labels.desc} caption={labels.caption} viewBox="0 0 780 310" maxWidth={780}>
      ...
      <line x1={155} y1={50} x2={175} y2={50} stroke="var(--svg-stroke)" strokeWidth={1.5} markerEnd="url(#dfArrow)" />
      ...
      <line x1={267} y1={50} x2={287} y2={50} stroke="var(--svg-stroke)" strokeWidth={1.5} markerEnd="url(#dfArrow)" />
      ...
      <line x1={389} y1={50} x2={409} y2={50} stroke="var(--svg-stroke)" strokeWidth={1.5} markerEnd="url(#dfArrow)" />

      <rect x={411} y={20} width={355} height={80} fill="none" stroke="var(--svg-yellow-stroke)" strokeWidth={2} rx={8} strokeDasharray="6,3" />
      <Label x={588} y={16} anchor="middle" size={9} bold color="yellow">{labels.loopBadge}</Label>
      ...
      {inner.map((p, i) => {
        ...
        return (
          <g key={i}>
            ...
            {i < inner.length - 1 ? (
              <line x1={x + w} y1={50} x2={(xs[i + 1] ?? 0)} y2={50} stroke="var(--svg-stroke)" strokeWidth={1.5} markerEnd="url(#dfArrow)" />
            ) : null}
          </g>
        );
      })}

      <path d="M 733 67 L 733 90 L 450 90 L 450 67" fill="none" stroke="var(--svg-yellow-stroke)" strokeWidth={2} markerEnd="url(#dfArrowYellow)" />
      <Label x={591} y={87} anchor="middle" size={8} color="yellow">{labels.loopCondition}</Label>

      <line x1={588} y1={102} x2={588} y2={130} stroke="var(--svg-stroke)" strokeWidth={1.5} markerEnd="url(#dfArrow)" />
      <Label x={588} y={148} anchor="middle" size={9} color="light">{labels.convergedLabel}</Label>
      <line x1={588} y1={155} x2={588} y2={175} stroke="var(--svg-stroke)" strokeWidth={1.5} markerEnd="url(#dfArrow)" />
      ...
      <line x1={588} y1={212} x2={588} y2={235} stroke="var(--svg-stroke)" strokeWidth={1.5} markerEnd="url(#dfArrow)" />
