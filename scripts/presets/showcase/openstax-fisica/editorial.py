...
BOOK = {
    "es": {
        ...
        "words": {"here": "aquí", "answer": "Respuesta.", "check": "Compruebe lo aprendido", "example": "Ejemplo", "note": "Nota", "link": "Enlace", "lab": "Práctica", "tips": "Consejos", "aside": "Curiosidad", "opener": "la fotografía de apertura del capítulo"},
    ...
    "en": {
        ...
        "words": {"here": "here", "answer": "Answer.", "check": "Check Your Understanding", "example": "Worked Example", "note": "Note", "link": "Link", "lab": "Snap Lab", "tips": "Tips For Success", "aside": "Fun in Physics", "opener": "the chapter-opening photograph"},
