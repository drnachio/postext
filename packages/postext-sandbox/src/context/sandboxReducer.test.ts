...
describe('book actions', () => {
  ...
  it('SET_CHAPTER_LAYOUT records a chapter layout and forgets it with the chapter', () => {
    const layout = { chapterId: 'b', markdown: '# B', configKey: 'c', resourcesKey: 'r', engine: 'e', continuationKey: 'k', pageCount: 3, leadingBlankPages: 1, firstContentPageNumber: { delta: 1 }, firstContentPageFormat: 'decimal' as const, lastPageNumber: { delta: 2 }, lastPageFormat: 'decimal' as const, outline: [], outlineKey: '' };
